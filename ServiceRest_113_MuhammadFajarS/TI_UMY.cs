...
namespace ServiceRest_113_MuhammadFajarS
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source= LAPTOP-3AAAJO1I; Initial Catalog=TIUMY; Persist Security Info= True; User ID= sa; Password=123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source= LAPTOP-3AAAJO1I; Initial Catalog=TIUMY; Persist Security Info= True; User ID= sa; Password=123");
